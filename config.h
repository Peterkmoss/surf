...
static int surfuseragent =
    1; /* Append Surf version to default WebKit user agent */
...
#define PLUMB(u)                                                               \
  {                                                                            \
    .v = (const char *[]) { "/bin/sh", "-c", "xdg-open \"$0\"", u, NULL }      \
  }
...
#define VIDEOPLAY(u)                                                           \
  {                                                                            \
    .v = (const char *[]) {                                                    \
      "/bin/sh", "-c", "mpv --really-quiet \"$0\"", u, NULL                    \
    }                                                                          \
  }
